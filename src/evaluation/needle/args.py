...
class ModelArgs:
    ...
    model_max_position_embeddings: Optional[int] = field(
        default=None,
        metadata={'help': 'Maximum position.'},
    )
    rope_scaling_factor: Optional[int] = field(
        default=None,
        metadata={'help': 'rope_scaling_factor.'},
    )
    rope_scaling_type: Optional[str] = field(
        default=None,
        metadata={'help': 'rope_scaling_type.'},
    )
